import "./Profile.css";
import SidebarWrapper from "/src/components/SidebarWrapper/SidebarWrapper.jsx";
import ListingsFeed from "/src/components/ListingsFeed/ListingsFeed.jsx";
...
export default function Profile() {
  ...
  const listingsData = [
    ...
    },
    {
      ...
      price: '700',
      isSold: false,
      image: 'https://images.unsplash.com/photo-1579783900882-c0d3dad7b119?ixlib=rb-1.2.1&auto=format&fit=crop&w=300&q=80'
    },
    {
      id: 3,
    ...
    },
    {
      ...
      price: '350',
      isSold: true,
      image: 'https://images.unsplash.com/photo-1596461404969-9ae70f2830c1?ixlib=rb-1.2.1&auto=format&fit=crop&w=300&q=80'
    }
  ];

  const userIdentity = {
    avatarSrc: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&auto=format&fit=crop&w=256&q=80',
  ...
  const menuLinks = [
    {
      ...
      label: 'Підтримка',
      icon: (
        <svg className="sidebar-menu__icon-svg" fill="none" stroke="currentColor" viewBox="0 0 24 24">
